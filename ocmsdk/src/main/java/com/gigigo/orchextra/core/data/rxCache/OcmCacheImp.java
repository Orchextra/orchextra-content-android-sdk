...
@Singleton
public class OcmCacheImp implements OcmCache {
    private final OcmDatabase ocmDatabase;
    private final Context mContext;

    @Inject
    public OcmCacheImp(Context context, @CacheDir String cacheDir) {
        this.ocmDatabase = OcmDatabase.Companion.create(context);
        this.mContext = context;
    }

    @Override
    public Observable<DbMenuContentData> getMenus() {
    ...
    @Override
    public void putMenus(ApiMenuContentData apiMenuContentData) {
    ...
    @Override
    public boolean hasMenusCached() {
        int versionDataCount = ocmDatabase.menuDao().hasMenus();
        return (versionDataCount == 1);
    }

    @Override
    public Observable<DbSectionContentData> getSection(@NonNull final String elementUrl) {
        return Observable.create(emitter -> {
    ...
    @Override
    public void putSection(@NonNull ApiSectionContentData apiSectionContentData,
                           @NonNull String key) {
    ...
    @Override
    public boolean isSectionCached(String elementUrl) {
        int sectionDataCount = ocmDatabase.sectionDao().hasSectionContentData(elementUrl);
        return (sectionDataCount == 1);
    }

    @Override
    public boolean isSectionExpired(String elementUrl) {
        return false;
    }

    //region ELEMENT
    @Override
    public Observable<DbElementData> getDetail(String slug) {
        return Observable.create(emitter -> {
    ...
    @Override
    public boolean isDetailCached(@NonNull String slug) {
        try {
    ...
    @Override
    public boolean isDetailExpired(String slug) {
        return false;
    }

    @Override
    public void putDetail(@NonNull ApiElementData apiElementData, @NonNull String key) {
    ...
    //region VIDEO
    @Override
    public Observable<DbVideoData> getVideo(String videoId) {
        return Observable.create(emitter -> {
    ...
    @Override
    public void putVideo(VimeoInfo vimeoInfo) {
    ...
    @Override
    public boolean isVideoExpired(String videoId) {
    ...
    @Override
    public void evictAll(boolean images, boolean data) {
        if (data) {
            Observable.create(emitter -> {
    ...
    private boolean deleteDir(File dir) {
        ...
        Timber.d("%s%s", (deleted + " -> ").toUpperCase(), dir.getPath());
        return deleted;
    }
