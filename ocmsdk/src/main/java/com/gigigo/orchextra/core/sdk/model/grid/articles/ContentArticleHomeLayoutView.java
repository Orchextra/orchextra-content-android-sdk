...
public class ContentArticleHomeLayoutView extends UiGridBaseContentData implements ArticleView {
    ...
    @Inject
    ContentArticleHomeLayoutViewPresenter presenter;
    ...
    @Override
    public void showArticle(List<ArticleElement<ArticleElementRender>> elements) {
    ...
    @Override
    public void setErrorView(View errorLayoutView) {
    ...
    @Override
    public void showNewExistingContent() {
