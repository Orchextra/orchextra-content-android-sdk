...
public class MainActivity extends AppCompatActivity {
    ...
    private OcmCustomBehaviourDelegate customPropertiesDelegate = new OcmCustomBehaviourDelegate() {
        ...
        @Override
        public void customizationForContent(@NonNull Map<String, ?> customProperties,
        ...
        @Override
        public void contentNeedsValidation(@NonNull Map<String, ?> customProperties,
    ...
    private void getContent() {
        ...
        Ocm.getMenus(new OcmCallbacks.Menus() {
            @Override
            public void onMenusLoaded(final UiMenuData uiMenuData) {
            ...
            @Override
            public void onMenusFails(Throwable e) {
                Timber.e(e, "getMenus()");
    ...
    private void createLocationService() {
        ...
        locationManager.setListener(new OxLocationListener() {
            @Override
            public void onLocationUpdated(@NonNull OxPoint location) {
                Timber.d("OXPoint received");
            }
